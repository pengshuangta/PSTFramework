#
#  Be sure to run `pod spec lint PSTFramework.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.social_media_url   = "http://twitter.com/彭双塔"
  ...
  s.source       = { :git => "https://github.com/pengshuangta/PSTFramework.git", :tag => "0.0.1" }
